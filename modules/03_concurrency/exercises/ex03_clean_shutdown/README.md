# Module 03_concurrency - ex03_clean_shutdown

## 1) Title + Mission
Mission: ThreadPool shutdown guard. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
