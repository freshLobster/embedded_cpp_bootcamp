# Module 03_concurrency - ex02_deadlock

## 1) Title + Mission
Mission: Fix deadlock. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
