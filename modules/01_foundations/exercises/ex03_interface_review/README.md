# Module 01_foundations - ex03_interface_review

## 1) Title + Mission
Mission: Tidy pipeline interface. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
