# Module 07_perf - ex03_perf_regression

## 1) Title + Mission
Mission: Remove perf regression. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
Optional (perf tooling, used in this module):
```
...
- Learner attempt:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/07_perf/exercises/ex03_perf_regression`
- Solution check:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/07_perf/exercises/ex03_perf_regression --use-solution`
- High-level scoring:
