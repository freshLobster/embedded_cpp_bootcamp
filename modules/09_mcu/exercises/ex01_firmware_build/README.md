# Module 09_mcu - ex01_firmware_build

## 1) Title + Mission
Mission: Firmware skeleton. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
Optional (MCU tooling for hardware path):
```
sudo apt-get install -y openocd esptool
```
...
### Hardware required (optional, MCU path)
BOM (generic):
- ESP32-C3 dev board
...
- Learner attempt:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/09_mcu/exercises/ex01_firmware_build`
- Solution check:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/09_mcu/exercises/ex01_firmware_build --use-solution`
- High-level scoring:
