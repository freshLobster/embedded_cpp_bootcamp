# Module 09_mcu - ex03_uart_bridge

## 1) Title + Mission
Mission: UART bridge. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
- Learner attempt:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/09_mcu/exercises/ex03_uart_bridge`
- Solution check:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/09_mcu/exercises/ex03_uart_bridge --use-solution`
- High-level scoring:
