# Module 02_memory - ex03_heaptrack

## 1) Title + Mission
Mission: Capture heap profile. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
Optional (heap profiling for this exercise):
```
