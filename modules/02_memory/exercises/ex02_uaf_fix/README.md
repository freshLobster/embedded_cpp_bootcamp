# Module 02_memory - ex02_uaf_fix

## 1) Title + Mission
Mission: Fix use-after-free. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
