# Module 11_cuda_basics - ex01_env

## 1) Title + Mission
Mission: CUDA env capture. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
- Learner attempt:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/11_cuda_basics/exercises/ex01_env`
- Solution check:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/11_cuda_basics/exercises/ex01_env --use-solution`
- High-level scoring:
