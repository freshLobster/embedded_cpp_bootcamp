# Module 11_cuda_basics - ex03_raii_buffer

## 1) Title + Mission
Mission: CudaBuffer RAII. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
- Learner attempt:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/11_cuda_basics/exercises/ex03_raii_buffer`
- Solution check:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/11_cuda_basics/exercises/ex03_raii_buffer --use-solution`
- High-level scoring:
