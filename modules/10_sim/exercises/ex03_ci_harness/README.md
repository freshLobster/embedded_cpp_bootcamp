# Module 10_sim - ex03_ci_harness

## 1) Title + Mission
Mission: Simulation test entry. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
- Learner attempt:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/10_sim/exercises/ex03_ci_harness`
- Solution check:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/10_sim/exercises/ex03_ci_harness --use-solution`
- High-level scoring:
