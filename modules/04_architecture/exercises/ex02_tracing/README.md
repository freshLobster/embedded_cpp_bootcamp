# Module 04_architecture - ex02_tracing

## 1) Title + Mission
Mission: Add tracing markers. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
