# Module 04_architecture - ex03_backpressure

## 1) Title + Mission
Mission: Backpressure experiment. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
