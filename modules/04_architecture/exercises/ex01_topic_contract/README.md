# Module 04_architecture - ex01_topic_contract

## 1) Title + Mission
Mission: Document topics. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
