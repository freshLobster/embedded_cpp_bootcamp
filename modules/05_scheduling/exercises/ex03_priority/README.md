# Module 05_scheduling - ex03_priority

## 1) Title + Mission
Mission: Priority experiment. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
