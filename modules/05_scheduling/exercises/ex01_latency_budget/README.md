# Module 05_scheduling - ex01_latency_budget

## 1) Title + Mission
Mission: Latency CSV. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
