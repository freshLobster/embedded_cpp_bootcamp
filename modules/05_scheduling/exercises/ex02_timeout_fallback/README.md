# Module 05_scheduling - ex02_timeout_fallback

## 1) Title + Mission
Mission: Timeout watchdog. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
