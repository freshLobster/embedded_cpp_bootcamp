# Module 06_debugging - ex01_asan

## 1) Title + Mission
Mission: ASan capture. You will use a tiny, isolated codebase to practice the build/test/grade loop in a deterministic way.
...
- Learner attempt:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/06_debugging/exercises/ex01_asan`
- Solution check:
  `python3 ../../../../tools/grader/grade.py --exercise ../../../../modules/06_debugging/exercises/ex01_asan --use-solution`
- High-level scoring:
